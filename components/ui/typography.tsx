...
export function H3({ children, className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3 className={cn('font-sans text-lg font-medium tracking-tight', className)} {...props}>
      {children}
    </h3>
  )
}
...
export function Body({
  ...
  return (
    <p
      className={cn('font-sans text-base sm:text-lg leading-8 text-foreground/70', className)}
      {...props}
    >
      {children}
    </p>
...
export function Muted({ children, className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
  return (
    <span className={cn('text-muted-foreground text-sm sm:text-base', className)} {...props}>
      {children}
    </span>
  )
}
...
export function Caption({ children, className, ...props }: React.HTMLAttributes<HTMLSpanElement>) {
  return (
    <span
      className={cn('text-muted-foreground text-xs uppercase tracking-widest', className)}
      {...props}
    >
      {children}
    </span>
...
export function Quote({ children, className, ...props }: React.HTMLAttributes<HTMLElement>) {
  return (
    <blockquote
...
export function Serif({
  ...
  return (
    <p
      className={cn('font-serif text-base sm:text-lg leading-8 text-foreground/70', className)}
      {...props}
    >
      {children}
    </p>
